                ...
                <div>
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    <select
                      ...
                      className="shrink-0 min-w-[10.5rem] max-w-[min(46%,13.5rem)] sm:min-w-[11.5rem] sm:max-w-[14rem] pl-3 pr-8 py-3 rounded-lg border text-[#101828] text-sm focus:outline-none focus:ring-2 focus:ring-[#101828]/20 focus:border-[#101828] appearance-none bg-no-repeat bg-right"
