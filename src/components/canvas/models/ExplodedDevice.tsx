...
import { PCBLayer, DisplayLayer, FrameWithDialLayer, BatteryLayer, MotherboardLayer, BackCaseGLBLayer } from './layers'
...
export default function ExplodedDevice({
  ...
  return (
    ...
    >
      ...
      {/* Layer 4.5: Motherboard - positioned over battery */}
      <MotherboardLayer
        position={[0, 0.1, layerOffsets.battery]}
        rotation={[-tiltAngle * 0.3, 0, 0]}
        scale={0.9}
