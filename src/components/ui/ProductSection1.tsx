...
export default function ProductSection1() {
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-0 lg:min-h-[calc(100vh-80px)] lg:flex lg:items-center overflow-visible">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-8 xl:gap-12 lg:items-center overflow-visible">
          ...
          <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end lg:items-center overflow-visible min-h-[280px] sm:min-h-[360px] lg:min-h-0">
            <div className="relative w-full max-w-[300px] sm:max-w-[380px] lg:max-w-none lg:w-[680px] xl:w-[760px] aspect-[3/4] shrink-0 overflow-visible lg:origin-center lg:rotate-[10deg] lg:translate-x-[80px] lg:translate-y-[20px] lg:scale-[1.05]">
              <Image
